        ...
        >
          <Grid item xs={1} sm={3} lg={3}>
            <Link to="/">
              <img
                src={Logo}
                style={{ width: "30%", height: "30%", minWidth: "40px" }}
                className="logo"
                alt="Logo"
              />
            </Link>
          ...
          <Grid
            ...
            sm={3}
            lg={3}
            style={{ display: "flex", gap: "5%", paddingLeft: "2%" }}
          >
            <MenuDropDown />
            <Link to="carrito" style={{ color: "#2e5137", paddingLeft: "1em" }}>
              <Button style={{ color: "#2e5137" }}>
                <ShoppingCartIcon style={{ paddingRight: "5%" }} /> Shopping
              </Button>
            </Link>
          </Grid>
        </nav>
